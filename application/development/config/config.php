...
|
*/
$config['encryption_key'] = '110e022a6eb581ec92315b02d2007df4';
...
|--------------------------------------------------------------------------
|
| This list is use for user role access
|
*/
$config['ifoure_methods']['main'] = array('index','about');
$config['ifoure_methods']['user'] = array('index');
...
$config['audit_trail_table'] = '_audit_trail';
